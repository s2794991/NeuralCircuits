...
# 10 PCs account for about 81% of the expression variation in this dataset
n_pcs = 10
n_genes_to_show = 10
...
# CV for two main spatial PCs
cv = KFold(n_splits=5, shuffle=True, random_state=42)
cv_check = {}
for pc in ["expression_PC3", "expression_PC4"]:
    ...
    cv_check[pc] = cv_scores.mean()


# Look gene by gene not using expression PCs
gene_tests = []
...
# Avoid very small adj q
top_genes_out["q_value"] = top_genes_out["q_value"].map(
